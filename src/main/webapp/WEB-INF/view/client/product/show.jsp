        ...
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
                ...
                <head>
                    ...
                    <title>Product - MobileShop</title>
                                            ...
                                            <div class="col-12" id="factoryFilter">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="factory-1"
                                                        value="APPLE">
                                                    <label class="form-check-label" for="factory-1">Apple (iPhone)</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="factory-5"
                                                        value="HONOR">
                                                    <label class="form-check-label" for="factory-5">HONOR</label>
                                                </div>
                                            </div>
                                            <div class="col-12" id="targetFilter">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-1"
                                                        value="3GB">
                                                    <label class="form-check-label" for="target-1">3GB</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-2"
                                                        value="4GB">
                                                    <label class="form-check-label" for="target-2">4GB</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-3"
                                                        value="6GB">
                                                    <label class="form-check-label" for="target-3">6GB</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-4"
                                                        value="8GB">
                                                    <label class="form-check-label" for="target-4">8GB</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-5"
                                                        value="12GB">
                                                    <label class="form-check-label" for="target-5">12GB</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-6"
                                                           value="16GB">
                                                    <label class="form-check-label" for="target-6">16GB</label>
                                                </div>
                                            </div>
