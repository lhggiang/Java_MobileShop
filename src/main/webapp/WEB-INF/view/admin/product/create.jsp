    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
            ...
            <head>
                ...
                <title>Create Order - MobileShop</title>
            ...
            <body class="sb-nav-fixed">
                                ...
                                <div class="mt-5">
                                    <div class="row">
                                        <div class="col-md-6 col-12 mx-auto">
                                            ...
                                            <hr />
                                            <form:form id="createProductForm" class="row" enctype="multipart/form-data" modelAttribute="newProduct">
                                            <c:set var="errorName">
                                                ...
                                                <div class="mb-3 col-12 col-md-6">
                                                    ...
                                                    <input class="form-control" type="file" id="avatarFile"
                                                        accept=".png, .jpg, .jpeg" name="hoanggiangFile" />
                                                </div>
                ...
                <script>
                    $(document).ready(() => {
                        ...
                        const submitButton = createProductForm.find("button[type='submit']");
