                                ...
                                <div class="row g-4">
                                    <div class="col-lg-6 d-flex justify-content-center align-items-center">
                                        <div class="border rounded w-100">
                                            <a href="#">
                                                <img src="/client/img/${product.image}" class="img-fluid rounded w-100" style="height: 500px; object-fit: cover;" alt="Image">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                            ...
                                            <ul class="list-unstyled fruite-categorie">
                                                <li>
                                                    <div class="d-flex justify-content-between fruite-name">
                                                        <a href="#"><i class="fas fa-apple-alt me-2"></i>Apple (iPhone)</a>
                                                        <span>(3)</span>
                                                    </div>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <div class="d-flex justify-content-between fruite-name">
                                                        <a href="#"><i class="fas fa-apple-alt me-2"></i>HONOR</a>
                                                        <span>(5)</span>
                                                    </div>
                                                </li>
                                            </ul>
